                ...
                <div className="p-4 flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[10px] text-slate-500 font-mono mt-0.5">
                      {option.coordinates.lat.toFixed(4)},{" "}
                      {option.coordinates.lng.toFixed(4)}
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      {Object.entries(option.data).map(([key, value]) => {
                        ...
                        return (
                          <div
                            key={key}
                            className="p-3 rounded-lg bg-slate-800/20 border border-slate-700/20"
                          >
        ...
        <div className="p-4 rounded-xl bg-slate-800/20 border border-slate-700/30 flex items-start gap-3">
          ...
          <div className="text-xs text-slate-400 leading-relaxed">
            <span className="font-bold text-slate-300">
              51% capital-weighted required.
            </span>{" "}
            Location selection needs majority approval. VIN provides 3 vetted
            options. The community picks one. Cannot be changed after selection
