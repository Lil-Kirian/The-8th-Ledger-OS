...
async function main() {
  ...
  for (const u of [primaryAdmin, demoAdmin, demoSubAdmin, demoUser]) {
    await prisma.wallet.upsert({
      ...
      create: {
        ledgerId: u.ledgerId,
        balance: u.ledgerId === "LED-ADMIN-001" ? 5_000_000 : u.ledgerId === "LED-SUBADMIN-001" ? 500_000 : u.ledgerId === "LED-USER-001" ? 50_000 : 1_000_000,
        lockedBalance: 0,
        currency: "USD",
      },
    });
  ...
  const demoPool1 = await prisma.pool.upsert({
    ...
    create: {
      ...
      documents: JSON.stringify([
        ...
        { name: "Insurance Policy", url: "#", type: "pdf", category: "insurance" },
    ...
    data: [
      {
        hallId: demoHall1.id,
        userId: demoAdmin.id,
        content: "Welcome to the Sovereign Heights Parliament. This Hall is now LIVE. All decisions require 51% capital-weighted approval. No one is above the vote.",
        type: "system",
      ...
      },
      {
        hallId: demoHall1.id,
        userId: demoAdmin.id,
        content: "The first proposal is live: Set Monthly Rent at $4,500. Please review and vote. Execution will begin immediately upon passage.",
        type: "system",
      ...
      },
      {
        hallId: demoHall1.id,
        userId: demoSubAdmin.id,
        content: "Market analysis confirms $4,500 is competitive for Dubai Marina 2BR units. Comparable units rent at $4,200–$4,800. I vote YES.",
        type: "text",
      ...
      },
      {
        hallId: demoHall1.id,
        userId: demoUser.id,
        content: "First dividend already hit my wallet. This system is unreal. Looking forward to the next acquisition vote.",
        type: "text",
  ...
  await prisma.vote.createMany({
    data: [
      { proposalId: proposal1.id, userId: demoAdmin.id, weight: 33.33, choice: "yes" },
      { proposalId: proposal1.id, userId: demoSubAdmin.id, weight: 16.67, choice: "yes" },
    ],
  });
  ...
  await prisma.hallActivity.createMany({
    data: [
      { hallId: demoHall1.id, userId: demoAdmin.id, type: "proposal", description: "Proposal created: Set Monthly Rent at $4,500" },
      { hallId: demoHall1.id, userId: demoAdmin.id, type: "vote", description: "Vote cast: YES (33.33% weight)" },
      { hallId: demoHall1.id, userId: demoSubAdmin.id, type: "vote", description: "Vote cast: YES (16.67% weight)" },
      { hallId: demoHall1.id, type: "dividend", description: "First dividend distributed: $3,600 community net" },
      { hallId: demoHall1.id, userId: demoAdmin.id, type: "join", description: "Hall activated by admin" },
    ],
  });
  ...
  await prisma.pirAllocation.createMany({
    data: [
      { hallId: demoHall1.id, pillar: "shield", amount: 25000, purpose: "Lloyd's insurance coverage, casualty, liability, force majeure", spent: 1500 },
      { hallId: demoHall1.id, pillar: "seal", amount: 20000, purpose: "Entity registration, operating agreements, beneficial interest documents", spent: 5000 },
      { hallId: demoHall1.id, pillar: "forge", amount: 20000, purpose: "Repairs, upkeep, vendor contracts, management fees", spent: 0 },
      { hallId: demoHall1.id, pillar: "spire", amount: 15000, purpose: "Protocol development, infrastructure, API, audits", spent: 3000 },
      { hallId: demoHall1.id, pillar: "vanguard", amount: 12000, purpose: "New vertical R&D, geographic expansion, ecosystem grants", spent: 0 },
      { hallId: demoHall1.id, pillar: "sanctuary", amount: 8000, purpose: "Vacancy coverage, dividend smoothing, market downturn, closure protection", spent: 0 },
    ],
  });
  ...
  await prisma.ahgiSnapshot.create({
    data: {
      hallId: demoHall1.id,
      score: 72,
      healthMetrics: JSON.stringify({ occupancy: 95, maintenanceBacklog: 2, tenantSatisfaction: 88 }),
      growthMetrics: JSON.stringify({ propertyValueIndex: 108, rentGrowthYoY: 5, appreciation: 3 }),
      recordedAt: now,
    },
  });
  ...
  await prisma.forgeLedger.create({
    data: {
      ...
      entries: JSON.stringify([
        { type: "vendor_contract", vendor: "Dubai Property Management Ltd", cost: 1500, description: "Monthly property management fee" },
        { type: "vendor_contract", vendor: "CleanCo Dubai", cost: 400, description: "Bi-weekly cleaning service" },
      ]),
      businessRevenue: 0,
      costOfGoodsSold: 0,
    },
    ...
    data: [
      {
        ...
        content: "Policy #2847 renewed. 12 months. Lloyd's of London. No action required.",
        amount: 25000,
      },
      {
        hallId: demoHall1.id,
      ...
      },
      {
        ...
        content: "Asset book value increased 8% this quarter. Driven by: rent increase (+5%), property appreciation (+3%).",
        amount: 20000,
      },
    ],
  });
  ...
  const demoPool2 = await prisma.pool.upsert({
    ...
    create: {
      ...
      documents: JSON.stringify([
        { name: "Business License", url: "#", type: "pdf", category: "compliance" },
        { name: "Health Inspection", url: "#", type: "pdf", category: "compliance" },
  ...
  const worker1 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 88,
      shiftSchedule: JSON.stringify({ mon: "08:00-18:00", tue: "08:00-18:00", wed: "08:00-18:00", thu: "08:00-18:00", fri: "08:00-18:00", sat: "09:00-15:00", sun: "off" }),
      department: "Admin",
    },
  });
  ...
  const worker2 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 75,
      shiftSchedule: JSON.stringify({ mon: "07:00-15:00", tue: "07:00-15:00", wed: "off", thu: "07:00-15:00", fri: "07:00-15:00", sat: "08:00-16:00", sun: "off" }),
      department: "Floor",
    },
  });
  ...
  const worker3 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 82,
      shiftSchedule: JSON.stringify({ mon: "06:00-14:00", tue: "06:00-14:00", wed: "06:00-14:00", thu: "off", fri: "06:00-14:00", sat: "06:00-14:00", sun: "off" }),
      department: "Floor",
    },
  });
  ...
  const worker4 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 91,
      shiftSchedule: JSON.stringify({ mon: "07:00-15:00", tue: "07:00-15:00", wed: "07:00-15:00", thu: "07:00-15:00", fri: "07:00-15:00", sat: "07:00-13:00", sun: "off" }),
      department: "Kitchen",
    },
  });
  ...
  const worker5 = await prisma.worker.create({
    data: {
      ...
      status: "probation",
      performanceScore: 68,
      shiftSchedule: JSON.stringify({ mon: "04:00-12:00", tue: "04:00-12:00", wed: "04:00-12:00", thu: "04:00-12:00", fri: "04:00-12:00", sat: "05:00-13:00", sun: "off" }),
      department: "Kitchen",
    },
  });
    ...
    data: [
      {
        workerId: worker1.id,
        score: 88,
        metrics: JSON.stringify({ attendance: 98, salesTarget: 105, customerComplaints: 0, inventoryAccuracy: 96 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "Continue current performance. Consider leadership training for regional expansion.",
      },
      {
        workerId: worker2.id,
        score: 75,
        metrics: JSON.stringify({ attendance: 92, transactionSpeed: 85, cashAccuracy: 99, customerRating: 78 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "Attend customer service workshop. Reduce checkout time by 15%.",
      },
      {
        workerId: worker3.id,
        score: 82,
        metrics: JSON.stringify({ attendance: 96, restockSpeed: 90, shelfOrganization: 88, damageRate: 2 }),
        reviewerId: demoAdmin.id,
      ...
      },
      {
        workerId: worker4.id,
        score: 91,
        metrics: JSON.stringify({ attendance: 99, meatYield: 97, customerSatisfaction: 94, wasteRate: 3 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "Exceeds expectations. Eligible for senior butcher promotion.",
      },
      {
        workerId: worker5.id,
        score: 68,
        metrics: JSON.stringify({ attendance: 85, productConsistency: 72, onTimeDelivery: 90, wasteRate: 8 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "30-day probation extension. Must improve consistency and reduce waste by 50%.",
      },
    ],
  });
    ...
    data: [
      {
        ...
        content: "Please prioritize restocking dairy section before morning rush. Supplier delivery delayed 2 hours.",
        relayedAt: now,
        status: "relayed",
      ...
      },
      {
        ...
        content: "Understood. I have shifted the stocker to dairy. ETA: 07:30 AM fully restocked.",
  ...
  await prisma.forgeLedger.create({
    data: {
      ...
      workerCount: 5,
      entries: JSON.stringify([
        { workerId: worker1.id, workerNumber: worker1.workerNumber, role: "Store Manager", salary: 1500, status: "paid" },
        { workerId: worker2.id, workerNumber: worker2.workerNumber, role: "Cashier", salary: 600, status: "paid" },
        { workerId: worker3.id, workerNumber: worker3.workerNumber, role: "Stocker", salary: 500, status: "paid" },
        { workerId: worker4.id, workerNumber: worker4.workerNumber, role: "Butcher", salary: 800, status: "paid" },
        { workerId: worker5.id, workerNumber: worker5.workerNumber, role: "Baker", salary: 750, status: "pending_review" },
      ]),
  ...
  const inventory3 = await prisma.inventoryItem.create({
    data: {
      ...
      description: "Budget smartphone for local market. Electronics department.",
      price: 120,
      quantity: 24,
      quantitySold: 6,
      status: "active",
    ...
    data: [
      {
        ...
        content: "5 workers paid via 8th Ledger Payroll System. Total: $4,150. Performance review scheduled for W-0002-005 (Baker — probation).",
        amount: 4150,
      },
      {
        hallId: demoHall2.id,
        ...
        content: "Premium Basmati Rice at 75% stock. Reorder threshold (50 units) will trigger in 4 days. Hall vote required for supplier change.",
        amount: 0,
      },
      {
        hallId: demoHall2.id,
        type: "valuation",
        title: "Dynamic Valuation Update",
        content: "MetroMart asset book value stable. Daily revenue consistent. AHGI: 65 (Stagnant — improvement plan recommended).",
        amount: 80000,
      },
    ],
  });
  ...
  await prisma.ahgiSnapshot.create({
    data: {
      hallId: demoHall2.id,
      score: 65,
      healthMetrics: JSON.stringify({ dailyRevenueConsistency: 82, customerRetention: 74, staffTurnover: 15 }),
      growthMetrics: JSON.stringify({ revenueGrowth: 3, locationValueIndex: 105, expansionPotential: 60 }),
      recordedAt: now,
    },
  });
  ...
  await prisma.pirAllocation.createMany({
    data: [
      { hallId: demoHall2.id, pillar: "shield", amount: 20000, purpose: "Business insurance, liability, worker compensation, product recall", spent: 2500 },
      { hallId: demoHall2.id, pillar: "seal", amount: 16000, purpose: "Business registration, operating license, tax compliance", spent: 6000 },
      { hallId: demoHall2.id, pillar: "forge", amount: 16000, purpose: "Equipment repair, refrigeration maintenance, facility upkeep", spent: 3200 },
      { hallId: demoHall2.id, pillar: "spire", amount: 12000, purpose: "POS system upgrades, inventory management software, security", spent: 4500 },
      { hallId: demoHall2.id, pillar: "vanguard", amount: 9600, purpose: "Second location scouting, private label product R&D", spent: 0 },
      { hallId: demoHall2.id, pillar: "sanctuary", amount: 6400, purpose: "Slow season reserve, emergency stock, payroll shortfall coverage", spent: 800 },
    ],
  });
  ...
  await prisma.hallActivity.createMany({
    data: [
      { hallId: demoHall2.id, userId: demoAdmin.id, type: "proposal", description: "Proposal passed: Hire Baker (probationary)" },
      { hallId: demoHall2.id, userId: demoAdmin.id, type: "vote", description: "Vote cast: YES (50% weight)" },
      { hallId: demoHall2.id, userId: demoSubAdmin.id, type: "vote", description: "Vote cast: YES (25% weight)" },
      { hallId: demoHall2.id, type: "dividend", description: "Weekly dividend distributed: $7,850 net after payroll" },
      { hallId: demoHall2.id, type: "inventory", description: "Stock order approved: 500kg rice, 200L milk, 12 smartphones" },
      { hallId: demoHall2.id, userId: demoAdmin.id, type: "join", description: "MetroMart Operations Parliament activated" },
    ],
  });
  ...
  const sportWorker1 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 90,
      shiftSchedule: JSON.stringify({ mon: "09:00-18:00", tue: "09:00-18:00", wed: "09:00-18:00", thu: "09:00-18:00", fri: "09:00-18:00", sat: "match_day", sun: "off" }),
      department: "Admin",
    },
  });
  ...
  const sportWorker2 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 85,
      shiftSchedule: JSON.stringify({ mon: "07:00-15:00", tue: "07:00-15:00", wed: "07:00-15:00", thu: "07:00-15:00", fri: "07:00-15:00", sat: "match_day", sun: "off" }),
      department: "Field",
    },
  });
  ...
  const sportWorker3 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 78,
      shiftSchedule: JSON.stringify({ mon: "06:00-14:00", tue: "06:00-14:00", wed: "off", thu: "06:00-14:00", fri: "06:00-14:00", sat: "match_day", sun: "off" }),
      department: "Field",
    },
  });
  ...
  const sportWorker4 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 92,
      shiftSchedule: JSON.stringify({ mon: "08:00-16:00", tue: "08:00-16:00", wed: "08:00-16:00", thu: "08:00-16:00", fri: "08:00-16:00", sat: "match_day", sun: "off" }),
      department: "Field",
    },
  });
  ...
  const sportWorker5 = await prisma.worker.create({
    data: {
      ...
      status: "active",
      performanceScore: 80,
      shiftSchedule: JSON.stringify({ mon: "05:00-13:00", tue: "05:00-13:00", wed: "05:00-13:00", thu: "05:00-13:00", fri: "05:00-13:00", sat: "match_day", sun: "off" }),
      department: "Field",
    },
  });
    ...
    data: [
      {
        ...
        score: 90,
        metrics: JSON.stringify({ attendance: 99, revenueGrowth: 112, sponsorRetention: 95, fanEngagement: 88 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "Continue current performance. Explore stadium naming rights deal.",
      },
      {
        workerId: sportWorker2.id,
        score: 85,
        metrics: JSON.stringify({ attendance: 96, winRate: 68, playerDevelopment: 82, tacticalRating: 79 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "Focus on defensive organization. Target 75% win rate by Q4.",
      },
      {
        workerId: sportWorker3.id,
        score: 78,
        metrics: JSON.stringify({ attendance: 94, injuryPrevention: 71, fitnessTestScores: 85, sessionQuality: 80 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "Reduce soft-tissue injuries by 20%. Implement GPS tracking.",
      },
      {
        workerId: sportWorker4.id,
        score: 92,
        metrics: JSON.stringify({ attendance: 98, recoveryRate: 94, playerAvailability: 91, treatmentSatisfaction: 96 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "Exceeds expectations. Eligible for senior physio role expansion.",
      },
      {
        workerId: sportWorker5.id,
        score: 80,
        metrics: JSON.stringify({ attendance: 97, pitchQuality: 84, equipmentMaintenance: 88, weatherPrep: 76 }),
        reviewerId: demoAdmin.id,
        improvementPlan: "Improve drainage system before winter season. Budget request approved.",
      },
    ],
  });
    ...
    data: [
      {
        ...
        workerId: sportWorker2.id,
        direction: "hall_to_worker",
        content: "Saturday match vs United reserves — please prepare tactical briefing for players by Thursday.",
        relayedAt: now,
        status: "relayed",
        loggedBy: demoAdmin.ledgerId,
      },
      {
        ...
        workerId: sportWorker2.id,
        direction: "worker_to_hall",
        content: "Briefing ready. Video analysis uploaded. Injury report: 2 players doubtful. Recommend starting lineup adjustment.",
  ...
  await prisma.forgeLedger.create({
    data: {
      ...
      workerCount: 5,
      entries: JSON.stringify([
        { workerId: sportWorker1.id, workerNumber: sportWorker1.workerNumber, role: "Club Manager", salary: 2000, status: "paid" },
        { workerId: sportWorker2.id, workerNumber: sportWorker2.workerNumber, role: "Head Coach", salary: 1800, status: "paid" },
        { workerId: sportWorker3.id, workerNumber: sportWorker3.workerNumber, role: "Fitness Trainer", salary: 900, status: "paid" },
        { workerId: sportWorker4.id, workerNumber: sportWorker4.workerNumber, role: "Physiotherapist", salary: 1100, status: "paid" },
        { workerId: sportWorker5.id, workerNumber: sportWorker5.workerNumber, role: "Groundskeeper", salary: 650, status: "paid" },
      ]),
  ...
  const sportInventory1 = await prisma.inventoryItem.create({
    data: {
      ...
      description: "Official home kit. Embroidered club crest. Adult sizes S-XXL.",
      price: 65,
      quantity: 500,
      quantitySold: 145,
      status: "active",
  ...
  const sportInventory2 = await prisma.inventoryItem.create({
    data: {
      ...
      description: "Full training set: jersey, shorts, socks, and water bottle. Academy standard.",
      price: 45,
      quantity: 300,
      quantitySold: 92,
      status: "active",
  ...
  const sportInventory3 = await prisma.inventoryItem.create({
    data: {
      ...
      description: "Single match entry. Valid for any home league fixture. Digital QR code.",
      price: 18,
      quantity: 2800,
      quantitySold: 1240,
      status: "active",
    ...
    data: [
      {
        ...
        type: "payroll",
        title: "Payroll Executed",
        content: "5 staff paid via 8th Ledger Payroll System. Total: $6,450. Club Manager bonus approved for sponsor retention.",
        amount: 6450,
      },
      {
        hallId: demoHall3.id,
        ...
        content: "Home Jersey stock at 71%. Reorder threshold (80 units) approaching. Hall vote required for manufacturer selection.",
        amount: 0,
      },
      {
        hallId: demoHall3.id,
        type: "valuation",
        title: "Dynamic Valuation Update",
        content: "Manchester Lions asset book value up 5%. Driven by: season ticket sales (+8%), merchandise growth (+12%).",
        amount: 126000,
      },
    ],
  });
  ...
  await prisma.ahgiSnapshot.create({
    data: {
      hallId: demoHall3.id,
      score: 74,
      healthMetrics: JSON.stringify({ matchAttendance: 78, playerInjuryRate: 12, pitchCondition: 91, staffRetention: 88 }),
      growthMetrics: JSON.stringify({ seasonTicketGrowth: 15, merchandiseGrowth: 22, sponsorValueIndex: 108, youthEnrollment: 34 }),
      recordedAt: now,
    },
  });
  ...
  await prisma.pirAllocation.createMany({
    data: [
      { hallId: demoHall3.id, pillar: "shield", amount: 30000, purpose: "Player injury insurance, liability, stadium casualty, force majeure", spent: 3500 },
      { hallId: demoHall3.id, pillar: "seal", amount: 20000, purpose: "Club registration, FA license, operating agreements, beneficial interest", spent: 8000 },
      { hallId: demoHall3.id, pillar: "forge", amount: 20000, purpose: "Pitch maintenance, gym equipment, stadium repairs, kit replacement", spent: 4200 },
      { hallId: demoHall3.id, pillar: "spire", amount: 12000, purpose: "Ticketing system, fan app, security upgrades, broadcast equipment", spent: 5500 },
      { hallId: demoHall3.id, pillar: "vanguard", amount: 10000, purpose: "Women's team expansion, academy scouting, international tour", spent: 0 },
      { hallId: demoHall3.id, pillar: "sanctuary", amount: 8000, purpose: "Off-season reserve, injury crisis fund, match cancellation coverage", spent: 1200 },
    ],
  });
  ...
  await prisma.hallActivity.createMany({
    data: [
      { hallId: demoHall3.id, userId: demoAdmin.id, type: "proposal", description: "Proposal passed: Hire Head Coach (12-month contract)" },
      { hallId: demoHall3.id, userId: demoAdmin.id, type: "vote", description: "Vote cast: YES (41.67% weight)" },
      { hallId: demoHall3.id, userId: demoSubAdmin.id, type: "vote", description: "Vote cast: YES (25% weight)" },
      { hallId: demoHall3.id, type: "dividend", description: "Weekly dividend distributed: $11,150 net after payroll" },
      { hallId: demoHall3.id, type: "inventory", description: "Stock order approved: 300 home jerseys, 150 training kits, 2,000 match tickets" },
      { hallId: demoHall3.id, userId: demoAdmin.id, type: "join", description: "Manchester Lions FC Parliament activated" },
    ],
  });
    ...
    data: [
      {
        ...
        message: "Sovereign Heights Parliament is now live with 3 sovereign members.",
        actionUrl: "/halls",
      },
      {
        ledgerId: demoAdmin.ledgerId,
        type: "system",
        title: "Hall Activated",
        message: "MetroMart Operations Parliament is now live. Class III Active Operation.",
        actionUrl: "/halls",
      },
      {
        ledgerId: demoAdmin.ledgerId,
        type: "system",
        title: "Hall Activated",
        message: "Manchester Lions FC Parliament is now live. Class III Active Operation — 11th vertical unlocked.",
        actionUrl: "/halls",
      },
      {
        ledgerId: demoUser.ledgerId,
      ...
      },
      {
        ...
        type: "system",
        title: "Role Assigned",
        message: "You have been elected as Treasurer for Sovereign Heights Parliament.",
      ...
      },
      {
        ...
        message: "Your 5% listing in MetroMart is now live on the Ownership Market.",
      ...
      },
      {
        ...
        type: "marketplace",
        title: "PAC Listing Active",
        message: "Your 3% listing in Manchester Lions FC is now live on the Ownership Market.",
        actionUrl: "/marketplace/ownership",
      },
    ],
  });
  ...
  await prisma.auditEntry.create({
    data: {
      type: "hall_created",
      description: "MetroMart Operations Parliament created and activated — Class III",
  ...
  await prisma.auditEntry.create({
    data: {
      type: "hall_created",
      description: "Manchester Lions FC Parliament created and activated — Class III, LedgerSport (11th vertical)",
  ...
  console.log(`   Primary Admin : LED-8X2P-9LQ3     | Password: FounderQuantumKey2026! | 6-Factor Auth`);
  console.log(`   Admin         : LED-ADMIN-001    | Password: 8thledger2026         | 6-Factor Auth`);
  console.log(`   Sub-Admin     : LED-SUBADMIN-001 | Password: 8thledger2026         | 3-Factor Auth`);
  console.log(`   User          : LED-USER-001     | Password: 8thledger2026         | Standard`);
  console.log(`   ─────────────────────────────────────────────────────────────────────`);
  console.log(`   HALL 1 (Class I)  : Sovereign Heights Parliament — LedgerProp Dubai`);
  ...
  console.log(`   ─────────────────────────────────────────────────────────────────────`);
  console.log(`   HALL 2 (Class III): MetroMart Operations Parliament — LedgerBiz Nairobi`);
  ...
  console.log(`   IHCP: $5,000      | Inventory: ON | Forge: ON | IHCP Repaid: $2,300`);
  console.log(`   ─────────────────────────────────────────────────────────────────────`);
  console.log(`   HALL 3 (Class III): Manchester Lions FC Parliament — LedgerSport UK`);
  ...
  console.log(`   COGS: $4,800      | Business Revenue: $22,000 | Net: $11,150`);
  console.log(`   IHCP: $8,000      | Inventory: ON | Forge: ON | IHCP Repaid: $3,000`);
  console.log(`   ─────────────────────────────────────────────────────────────────────`);
  console.log(`   Oracle Standing   : 2 records seeded (Seer + Oracle tiers)`);
  console.log(`   Dynamic Valuation : Active on all 3 halls`);
  console.log(`   Forge Ledger      : Class I (vendors) + Class III (full payroll)`);
  console.log(`   Ownership Market  : 2 active listings with 48h escrow ready`);
  console.log(`   11 Verticals      : LedgerSport added as 11th sovereign asset class`);
}
